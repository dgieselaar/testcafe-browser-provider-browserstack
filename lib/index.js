...
var CAPABILITIES_FILE = process.env['BROWSERSTACK_CAPABILITIES'];
...
function debugConnector() {
    ...
    if (process.env.DEBUG_CONNECTOR) (_console = console).log.apply(_console, ['DEBUG_CONNECTOR'].concat(rest)); //eslint-disable-line no-console
}
...
exports.default = {
    ...
    _disposeConnector: function _disposeConnector() {
        ...
        (0, _util.debug)('disposeConnector');
        this.connectorPromise = this.connectorPromise.then(function () {
                ...
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                (0, _util.debug)('disposeConnector.resolved', !!connector);
                            ...
                            case 4:
                                (0, _util.debug)('disposeConnector.destroyed');
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 10:
                            ...
                            capabilities = (0, _extends3.default)({}, capabilities, JSON.parse(_fs2.default.readFileSync(CAPABILITIES_FILE)));
                            _context6.next = 20;
                            break;
